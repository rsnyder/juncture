...
function mount(mountPoint, html, setActiveParagraph) {
  ...
  observeVisible(mountPoint, setActiveParagraph)
}

export { elFromHtml, getMarkdown, getHtml, ghSourceFromLocation, markdownToHtml, mount, observeVisible, structureContent }