<template>
  ...
  <div ref="root" class="image">
    ...
    <div class="status">
      ...
      <div v-else class="annotations-indicator" @click="toggleAnnotations">
  ...
  function initOpenSeadragon() {
    ...
    let branch
    let path = source.value?.dir.slice(0,-1).split('/')
    ...
    annotator.value = new Annotator(osd.value, `${owner}/${repository}/${path.join('/')}`, props.repoIsWritable)
