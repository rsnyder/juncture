<template>
  ...
  <sl-dialog class="dialog" no-header :style="{'--width':dialogWidth, '--body-spacing':0, '--footer-spacing':'0.5em'}">
    <mdp-image v-if="selected" no-caption :src="selected.id" fit="contain"></mdp-image>
    <div slot="footer" class="footer">
      <mdp-caption :manifest="selected"></mdp-caption>
      <div class="controls push">
        ...
        <img src="https://mdpress.io/images/iiif.png" class="iiif" alt="IIIF manifest icon"
